...
const FormEditUser = () => {
  const {userTypeList, userDetail} = useSelector((state) => state.userReducer);
  ...
  const formik = useFormik({
    ...
    initialValues: {
      ...
      maLoaiNguoiDung: "QuanTri", // backend trả về null nên để default là QuanTri
